...
@Component
public class AbdmEncryption {
	
    public static final String ALGORITHM = "ECDH";
    public static final String CURVE = "curve25519";
    public static final String PROVIDER = BouncyCastleProvider.PROVIDER_NAME;
    public com.example.HAD.common.EncryptionResponse encrypt(com.example.HAD.common.EncryptionRequest encryptionRequest) throws Exception {
        ...
        return new com.example.HAD.common.EncryptionResponse(encryptedData, keyToShare);
    }
